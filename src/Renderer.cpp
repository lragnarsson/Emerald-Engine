...
void Renderer::init()
{
    ...
    shaders[BLUR_RED_5] = load_shaders("build/shaders/blur.vert", "build/shaders/blur_red_5.frag");
    shaders[BLUR_RGB_5] = load_shaders("build/shaders/blur.vert", "build/shaders/blur_rgb_5.frag");
