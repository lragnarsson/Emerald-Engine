...
CC = g++
EXEC = emerald
CCFLAGS = -std=c++11 -g -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLM_FORCE_RADIANS -D_DEFAULT_SCENE_FILE_="\"res/scenes/scene_file.txt\"" -D$(FRUSTUM_NEAR) -D$(FRUSTUM_FAR) -D$(EMERALD_SCREEN_HEIGHT) -D$(EMERALD_SCREEN_WIDTH) -D$(SSAO_N_SAMPLES) -D$(ATT_QUAD) -D$(ATT_LIN) -D$(ATT_CON) -D$(MAX_LIGHTS) -D$(MAX_MODELS) -D$(SSAO_SCALE) -D$(SHADOW_SCALE) #-DPROFILING -D_DEBUG_LOADER_
INC =
