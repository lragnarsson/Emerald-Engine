...
MAX_LIGHTS="_MAX_LIGHTS_=15"
ATT_QUAD="_ATT_QUAD_=0.0008"
ATT_LIN="_ATT_LIN_=0.001"
ATT_CON="_ATT_CON_=1.0"
# ----------------

CC = g++
EXEC = emerald
CCFLAGS = -g -std=c++11 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLM_FORCE_RADIANS -D_DEFAULT_SCENE_FILE_="\"res/scenes/scene_file.txt\"" -D$(FRUSTUM_NEAR) -D$(FRUSTUM_FAR) -D$(SCREEN_HEIGHT) -D$(SCREEN_WIDTH) -D$(SSAO_N_SAMPLES) #-D_DEBUG_LOADER_
INC =
