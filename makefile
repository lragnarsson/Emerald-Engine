...
SSAO_N_SAMPLES="_SSAO_N_SAMPLES_=64"
# ----------------

CC = g++
EXEC = emerald
CCFLAGS = -std=c++11 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLM_FORCE_RADIANS -D_DEFAULT_SCENE_FILE_="\"scene_file.txt\"" -D$(FRUSTUM_NEAR) -D$(FRUSTUM_FAR) -D$(SCREEN_HEIGHT) -D$(SCREEN_WIDTH) -D$(SSAO_N_SAMPLES)
INC =
LDFLAGS = -lSDL2 -lSDL2_image -lassimp
FRAGMENT_SHADER_PRECOMPILE= "_MAX_LIGHTS_=100" $(FRUSTUM_NEAR) $(FRUSTUM_FAR) $(SCREEN_WIDTH) $(SCREEN_HEIGHT) $(SSAO_N_SAMPLES)
