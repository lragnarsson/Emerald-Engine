...
CC = g++
EXEC = emerald
CCFLAGS = -g -std=c++11 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLM_FORCE_RADIANS -D_DEFAULT_SCENE_FILE_="\"scene_file.txt\"" -D$(FRUSTUM_NEAR) -D$(FRUSTUM_FAR)
INC =
LDFLAGS = -lSDL2 -lSDL2_image -lassimp -lSDL2_ttf
